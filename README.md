...
Quantities can convert only between similar dimensions. Temperature conversion represents temperature differences, not absolute Celsius/Fahrenheit offsets.
...
- `new Unit(name, symbol, dimension, baseUnit?, factor?)`
- `Unit.register(unit)`
- `unit.toBase()`
